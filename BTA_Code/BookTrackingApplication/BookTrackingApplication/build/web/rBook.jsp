...
<html lang="en">
    ...
    <body>
        <div class="container">
            <h1><%=ActivityHourSettings.projectTitle%></h1>&nbsp;<B><br>            
            <h2><font face="Comic Sans MS" color="pink"><%=msg%></font></h2><br>            
            
            <div>
                <FORM METHOD="POST" ACTION="vbooksAdmin.jsp">
                    <fieldset>
                        <legend>
                            <h3>Books Submission Form</h3>                                                        
                        </legend>
                        <p>                        
                        <TABLE BORDER="0">
                            <TR>
                    ...
                    <P><INPUT TYPE="SUBMIT" VALUE="Fetch Books Assigned" >&nbsp;&nbsp;<INPUT TYPE="Reset" VALUE="ClearDetails" ></P>
                </FORM>
            </div>
        </div>
